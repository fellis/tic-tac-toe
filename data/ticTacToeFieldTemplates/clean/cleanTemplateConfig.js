...
const mapTemplateType = MapTemplateType.clean;
...
const  CleanTemplateConfig = new TemplateConfig(mapTemplateType, colors, backs, objects);

module.exports = CleanTemplateConfig;