...
const mapTemplateType = MapTemplateType.small;
...
const  SmallTemplateConfig = new TemplateConfig(mapTemplateType, colors, backs, objects);

module.exports = SmallTemplateConfig;