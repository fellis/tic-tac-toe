...
const mapTemplateType = MapTemplateType.diamond;
...
const  DiamondTemplateConfig = new TemplateConfig(mapTemplateType, colors, backs, objects);

module.exports = DiamondTemplateConfig;